...
# Si ves que corta, sube a 1600-2200.
...
def asegurar_hoja_respuestas(examen_md: str, ruta_md_apuntes: str) -> str:
    ...
    # Le damos apuntes + examen para resolver con coherencia
...
# ---------------------------------------------------------
# 4) Prompt robusto para generar preguntas “single-correct”
# ---------------------------------------------------------
def generar_test_desde_md(ruta_md: str) -> str:
    ...
    2) Cada pregunta debe tener EXACTAMENTE 1 opción correcta (A/B/C/D).
       ...
       - Si el apunte enumera varias afirmaciones correctas (ej: varias fuentes, tipos, pasos),
