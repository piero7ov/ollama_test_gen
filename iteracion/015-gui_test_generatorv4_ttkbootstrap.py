...
class App(BaseWindow):
    def __init__(self):
        # Si hay ttkbootstrap, podemos crear la ventana con theme
        if TTKBOOTSTRAP_AVAILABLE:
        ...
        # StringVar para que no pete si el usuario borra/escribe letras
    ...
    def _update_total(self):
        ...
        try:
            ...
            # Algunos temas manejan colores diferente, no pasa nada.
            pass
