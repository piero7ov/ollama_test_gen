...
# CONFIG
# ---------------------------------------------------------
ARCHIVO_PDF  = "Apuntes_T3_y_T4.pdf"
ARCHIVO_MD   = "Apuntes_T3_y_T4.md"
ARCHIVO_TEST = "Examen_T3_y_T4.md"

# Prueba:
# MODELO = "qwen2.5-coder:7b" --  Va mucho mejor despues de pruebas.
...
# ---------------------------------------------------------
# 3) Generar examen (1 prompt, V/F + corta) con mejoras
# ---------------------------------------------------------
def generar_examen_vf_y_corta(ruta_md: str) -> str:
    ...
    prompt = dedent(f"""
    Eres profesor/a. Con estos apuntes crea un mini-examen rápido:
    ...
    - Reparte las 8 preguntas por distintos temas/secciones del texto (no te quedes en un solo apartado).
    - En respuesta corta: NO copies frases literales del apunte ni incluyas pistas obvias en la pregunta
      (evita meter la misma definición casi completa en el enunciado).
    ...
    return ollama_generate_stream(prompt, etiqueta="Generando examen")
